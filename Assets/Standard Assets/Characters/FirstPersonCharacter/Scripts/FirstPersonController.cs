...
public class FirstPersonController : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.tag == "F1_E")
        {
            collision.GetComponentInParent<ElevatorScript>().playerIsInElevator = true;
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        {
            other.GetComponentInParent<ElevatorScript>().playerIsInElevator = false;
        }
    }
